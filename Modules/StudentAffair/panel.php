...
$picture = '../../Assets/Images/vectorFiles/Others/profilePicAvatar.jpg';

if ($personalDetails['picture'] != null && $personalDetails['picture'] != "" && dechex(ord($personalDetails['picture'])) != "ef") {
    $picture = 'StudentAffairsAssets/imageView.php';
}
*/
...
<head>
    ...
    <!--    <script src="ExamHeadAssets/examHeadPanelScripts.js" rel="script"></script>-->
...
<header class="text-center text-4xl p-2 pl-48">
    <label id="studentAffairsPanelTitleID">Dashboard</label>
    <div class="profilePictureDiv" id="viewProfileID">
        <div class="flex">
            <a href="#" name="viewExamHeadProfile" class="cursor-pointer flex">
                <img id="headerProfilePicture" src="<?php echo "xox"; ?>" width="40" style="max-width: 40px; max-height: 40px">
...
<div class="wrapper" style="height: 90vh">
    <div class="w-48 sidePanel p-2">
        ...
        <div class="mt-5 relative h-full">
            ...
            <!--            Students Management-->
            <div class="navigationItemDropdown" id="transcriptManagementID">
                <div class="flex justify-between items-center navDropBox" id="studentManagementDropBox">
                    <div class="flex items-center">
                        ...
                        <label class="pl-3">Students Management</label>
                    </div>
                ...
                <div class="menu menuClosed dropdownNavigationItemMenu" id="dropdownNavigationItemMenu">
                    <div class="menuItem" id="studentImportID">Import Student Data</div>
                    <div class="menuItem" id="manageStudentID">Manage Student</div>
                </div>
            </div>
            ...
            <form method="post" class="flex justify-center w-full bottom-3 absolute">
                <div class="logout rounded-md bg-white w-2/3 p-0.5 cursor-pointer" id="logout">
                    ...
                    <button name="logout" type="submit" class="pl-3 inline-block cursor-pointer font-bold" style="color: #01409B">
                        Logout
                    </button>
    ...
    <div class="ml-48 w-full h-full" id="studentAffairsMainContentId">
