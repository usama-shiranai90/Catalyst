        ...
        <section class=" cprofile-grid mx-0 my-0 ">
            <div class="mx-2 p-4 clo-container ">
                <div class="grid grid-cols-4 gap-6">
                    ...
                    <div class="shadow-lg rounded-2xl w-48 p-4 py-4 bg-white">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-catalystBlue-d1 text-2xl font-semibold mb-4 mt-4">
                                CGPA
                            </p>
                        </div>
                    </div>
                    <div class="shadow-lg rounded-2xl w-48 p-4 py-4 bg-white">
                        <div class="flex flex-col items-center justify-center">
                            <div class="rounded-full relative">
                                <p class="text-catalystBlue-d1 text-lg font-semibold mb-4 mt-4">Current Semester</p>
                            </div>
                            <p class="text-catalystBlue-d1 text-2xl font-semibold mb-4 mt-4">7</p>
                        </div>
                    </div>
                    <div class="shadow-lg rounded-2xl w-48 p-4 py-4 bg-white">
                        <div class="flex flex-col items-center justify-center">
