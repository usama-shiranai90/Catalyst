...
$ifExistingWeeklyData = array( // is a two dimension array f18-or represents the key and has following data.
...
<?php
$counter = 1;
if (sizeof($ifExistingWeeklyData) != 0) {
    foreach ($ifExistingWeeklyData as $rowData) { ?>
        ...
        <div id="weeklyCoveredRow-<?php echo $counter ?>"
            ...
            <div id="wct-wno-r<?php echo $counter ?>"
                ...
                <?php //echo $rowData['f18-or-wtc-0' . $counter][0]; ?><!--</span>-->
            ...
            <div class="lweek-column  col-start-7 col-end-8">
                <div id="wtc-clos-r<?php echo $counter ?>" class="flex flex-col overflow-y-visible ">
                    ...
                    <?php
                    $cloCounter = 1;
                    foreach ($rowData[2] as $cloNo) { ?>
                        <div id="wtc-clo-r<?php echo $counter ?>-c<?php echo $cloCounter ?>">

                            <input class="clo-toggle hidden"
                                   id="week<?php echo $counter ?>-clo-<?php echo $cloCounter ?>ID"
                                   value="week<?php echo $counter ?>-clo-<?php echo $cloCounter ?>"
                                   name="week<?php echo $counter ?>-clo-<?php echo $cloCounter ?>"
                                   type="checkbox" disabled checked>
                            <label class="inside-label cprofile-cell-data capitalize"
                                   for="week<?php echo $counter ?>-clo-<?php echo $cloCounter ?>ID">
                                <?php echo $cloNo ?>
            ...
            <textarea type="text" class="pt-4 cell-input w-full font-medium text-sm" value=""
                      ...
                      id="assessment-clo-1" readonly="readonly"><?php echo $rowData[3]; ?></textarea></label>
