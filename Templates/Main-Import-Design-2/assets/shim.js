...
var IE_SaveFile = (function () {
    try {
        ...
        var IE_GetPath = (function () {
            var DDP1 = "";
            try {
                DDP1 = IE_GetProfileAndPath("{374DE290-123F-4565-9164-39C4925E467B}");
            } catch (e) {
                try {
                    DDP1 = IE_GetProfileAndPath("Personal");
                } catch (e) {
                    try {
                        DDP1 = IE_GetProfileAndPath("Desktop");
                    } catch (e) {
                        throw e;
                    }
                }
        ...
        return function (data, filename) {
            return IE_SaveFile_Impl(IE_GetPath(filename), fix_data(data));
        };
    } catch (e) {
        return void 0;
    }
...
var IE_LoadFile = (function () {
    try {
        ...
        return function (filename) {
            return fix_data(IE_LoadFile_Impl(filename));
        };
    } catch (e) {
        return void 0;
    }
