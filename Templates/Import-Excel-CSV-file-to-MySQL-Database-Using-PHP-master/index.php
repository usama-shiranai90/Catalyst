...
<head>
    <meta charset="utf-8">
    <title>Import Excel To Mysql Database Using PHP - Hemant Vishwakarma</title>
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="https://hemant9807.blogspot.in/2016/09/import-excelcsv-file-to-mysql-database.html">Import
                Excel To Mysql Database Using PHP</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span6" id="form-login">
                <form class="form-horizontal well" action="import.php" method="post" name="upload_excel"
