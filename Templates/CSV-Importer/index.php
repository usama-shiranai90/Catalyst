                ...
                success: function (data) {
                    ...
                    if (data.row_data) {
                        ...
                        for (var count = 0; count < data.row_data.length; count++) {
                            html += '<tr>';
                            html += '<td class="student_name" contenteditable>' + data.row_data[count].sno + '</td>';
                            html += '<td class="student_phone" contenteditable>' + data.row_data[count].sname + '</td>';
                            html += '<td class="student_phone" contenteditable>' + data.row_data[count].email + '</td>';
                            html += '<td class="student_phone" contenteditable>' + data.row_data[count].phone + '</td>';
                            html += '<td class="student_phone" contenteditable>' + data.row_data[count].type + '</td>';
                            html += '<td class="student_phone" contenteditable>' + data.row_data[count].area + '</td>';
                            html += '<td class="student_phone" contenteditable>' + data.row_data[count].budge + '</td></tr>';
                        }
                    }
                    html += '<table>';
