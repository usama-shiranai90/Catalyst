...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2022 at 03:25 PM
...
INSERT INTO `assessment` (`assessmentCode`, `sectionCode`, `courseCode`, `assessmentType`, `assessmentSubType`, `title`, `totalMarks`, `weightage`) VALUES
(1, 4, 'SEN-32', 'Sessional', 'Quiz ', 'Firebase', 10, 5);
...
INSERT INTO `batch` (`batchCode`, `curriculumCode`, `programCode`, `year`) VALUES
(1, 1, 1, 2018);
...
INSERT INTO `clo` (`CLOCode`, `curriculumCode`, `programCode`, `courseCode`, `cloName`, `description`, `domain`, `btLevel`) VALUES
(1, 1, 1, 'SEN-32', 'CLO-1', 'Handwriting', 'ABC', '4'),
...
(1, 'SEN-31', 1, 1, 'Programming Fundamentals', 3, 2, 'BCSE', 'Undergraduate', 'ABC', 'ABc', 'XYZ', 'Programming Fundamental 2', 'Programming Fundamental 2', 'ABC', 'Programming Fundamental 2');
...
(1, 'F18-BCSE-011', 2, 2, 10, 6, 'Excellent'),
...
INSERT INTO `faculty` (`facultyCode`, `name`, `CNIC`, `officialEmail`, `personalEmail`, `address`, `contactNumber`, `picture`, `designation`, `additionalResponsibility`, `password`, `departmentCode`, `showEmail`) VALUES
('FUI-FURC-056', 'Dr. M. Aqeel Iqbal', '37401-5859968-5', 'maqeelIqbal@fui.edu.pk', 'maqeelIqbal@hotmail.com', 'Somewhere on earth', '0312-4589635', 0xefbbbf, 'Assistant Professor', NULL, '123456789', 1, 1);
...
INSERT INTO `student` (`studentRegCode`, `sectionCode`, `name`, `fatherName`, `contactNumber`, `officialEmail`, `personalEmail`, `bloodGroup`, `address`, `dateOfBirth`, `password`) VALUES
('F18-BCSE-011', 4, 'Fatima', 'Rahim', '0315-2376814', 'fatima2@gmail.com', 'fatima2@gmail.com', 'A', 'Tench bhatta Rwp', '2022-01-19', '123456'),
('F18-BCSE-018', 5, 'Maleeha Rahim', 'Abdul Rahim', '0315-2376813', 'maliharahim123@gmail.com', 'maliharahim123@gmail.com', 'A', 'Tench bhatta Rwp', '2022-01-19', '12345');
...
--
ALTER TABLE `assessment`
  MODIFY `assessmentCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `assessmentquestion`
--
ALTER TABLE `assessmentquestion`
  MODIFY `questionCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `batch`
--
ALTER TABLE `batch`
  MODIFY `batchCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `clo`
--
ALTER TABLE `clo`
  MODIFY `CLOCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `courseallocation`
--
ALTER TABLE `courseallocation`
  MODIFY `allocationCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `courseoffering`
--
ALTER TABLE `courseoffering`
  MODIFY `offeringCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `courseprofile`
--
ALTER TABLE `courseprofile`
  MODIFY `courseProfileCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `courseregistration`
--
ALTER TABLE `courseregistration`
  MODIFY `courseRegistrationCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `curriculum`
--
ALTER TABLE `curriculum`
  MODIFY `curriculumCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `facultyallocations`
  MODIFY `facultyAllocationsCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `plo`
--
ALTER TABLE `plo`
  MODIFY `PLOCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `program`
--
ALTER TABLE `program`
  MODIFY `programCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `season`
--
ALTER TABLE `season`
  MODIFY `seasonCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `section`
--
ALTER TABLE `section`
  MODIFY `sectionCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `semester`
--
ALTER TABLE `semester`
  MODIFY `semesterCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
